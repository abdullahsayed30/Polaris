...
Polaris records significant architecture choices as lightweight ADRs. Each record explains the context, the decision, and the operational or design consequences for the project.
